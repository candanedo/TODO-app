...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  # )
  # user.avatar.attach.(File.open('/Users⁩/⁨eduardojaviercandanedocontreras⁩/Downloads⁩/profile.jpg'))
  # user.save
  ...
  #     :password_confirmation => "edjacaco"
  # )
  # user.avatar.image.attach.(File.open('/Users⁩/⁨eduardojaviercandanedocontreras⁩/Downloads⁩/profile.jpg'))
  # user.save
